...
<script lang="ts">
	...
	const teamMember: TeamMember = {
		name: "Alex Morgan",
		role: "Founder & CEO",
		image: "/generated/image-a-professional-founder-stands-confidentl.webp"
	};
</script>
	...
	<div class="section-px section-py container mx-auto">
		<div class="relative mx-auto grid max-w-2xl place-items-center gap-16">
			<ScrollText
				...
				text={`"I watched brilliant engineers spend more time explaining their work than doing it. That's when I realized we needed to fundamentally rethink how teams share context. The best work happens in flow state, not status meetings."`}
			/>
